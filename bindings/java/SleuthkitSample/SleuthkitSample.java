...
public static void run(String imagePath) {
		try {
			...
			try {
				...
				Logger.getLogger(SleuthkitSample.class.getName()).log(Level.SEVERE, null, ex);
			}
			process.commit();
			...
			SleuthkitSample.usage(e.getMessage());
	...
	public static void main(String[] args) {
                System.out.println("Enter the imagefile path");
